...
public class FeederAndEjectSetPercentOutput extends CommandBase {
   ...
   * @param log logfile
   */
  public FeederAndEjectSetPercentOutput(double percentOut, Uptake uptake, Feeder feeder, FileLog log) {
    this.feeder = feeder;
    this.uptake = uptake;
    this.log = log;
